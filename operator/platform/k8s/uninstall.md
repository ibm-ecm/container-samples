# Uninstalling IBM FileNet Content Manager 5.5.4 on Certified Kubernetes
...
For example:
```bash
  $ kubectl delete -f descriptors/my_fncm_v1_fncm_cr.yaml
```
...
  $ kubectl delete -f descriptors/fncm_v1_fncm_crd.yaml
```
